...
class UPIToAccountSerializer(serializers.ModelSerializer):
    class Meta:
        model = UPIToAccount
        fields = '__all__'
...
class RCVerifyReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = RCVerifyReport
        fields = '__all__'

class RCVerifyReportSerializer2(serializers.ModelSerializer):
    class Meta:
        model = RCVerifyReport2
        fields = '__all__'

class ChallanReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = ChallanReport
        fields = '__all__'

class AddressTraceReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = AddressTraceReport
        fields = '__all__'

class MobileToDLAdvanceSerializer(serializers.ModelSerializer):
    class Meta:
        model = MobileToDLAdvance
        fields = '__all__'
